...
import {
  BRAND, CONTACTS, PG_PROPERTIES, ROOM_TYPES, FACILITIES, MEAL_PLAN,
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-accent via-background to-muted">
        <div className="container py-16 md:py-24">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl font-heading font-extrabold leading-tight text-foreground mb-4">
              {BRAND.tagline}
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <Button size="lg" asChild>
                <Link to="/our-pgs">
                  <ChevronRight className="h-4 w-4" /> View Our PGs
                </Link>
              </Button>
              ...
              <motion.div key={h.title} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
                <Card className="h-full text-center hover:shadow-md transition-shadow">
                  <CardContent className="pt-6 flex flex-col items-center gap-3">
                    <div className="h-12 w-12 rounded-full bg-primary/20 flex items-center justify-center text-secondary">
                      {iconMap[h.icon]}
                    </div>
                ...
                <Card className="overflow-hidden hover:shadow-lg transition-shadow group">
                  ...
                  <CardContent className="pt-4 space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground flex items-center gap-1">
                      <MapPin className="h-3 w-3" /> {pg.address.split(",")[0]}
                    </p>
                ...
                <Card className={`h-full text-center hover:shadow-lg transition-shadow ${i === 0 ? "border-2 border-secondary" : ""}`}>
                  <CardContent className="pt-6 space-y-3">
                    ...
                    <Button size="sm" asChild className="w-full">
                      <a href={whatsappLink(`Hi, I'm interested in ${r.sharing} ${r.acType} room at ₹${r.price}/month.`)} target="_blank" rel="noopener noreferrer">
                        Enquire Now
                      </a>
                    </Button>
                  </CardContent>
